...
int main()
{
	...
	while(1) {
		...
		switch (menu_terpilih) {
			...
			{
				int dd, mm, yy, tahunmasuk,nomorhp,semesterke,skslulus,bobotmatkul,semestermatkul;
				string id, nama, nrp, departemen, alamat,email, tambahmatkul, namamatkul, kodematkul;
				...
				cout<<"Jumlah SKS :";
				cin>>skslulus;
				cout<<"Ingin menambah mata kuliah? (Ya/Tidak)";
				cin>>tambahmatkul;
				if(tambahmatkul=="Ya")
				{
					cout<<"Masukkan mata kuliah yang ingin anda tambah!";
					cin.ignore();
					getline(cin, namamatkul);
					cout<<"Masukkan kode mata kuliah :";
					cin>>kodematkul;
					cout<<"Masukkan bobot SKS mata kuliah :";
					cin>>bobotmatkul;
					cout<<"Masukkan semester mata kuliah :";
					cin>>semestermatkul;
				}

				mahasiswa mahasiswa(id,nama,dd,mm,yy,nomorhp,alamat,email,nrp,departemen,tahunmasuk,semesterke,skslulus,
									bobotmatkul,semestermatkul,tambahmatkul,namamatkul,kodematkul);
			...
			case 4:
			{
				for(unsigned long i=0; i< recMhs.size(); i++)
				{
					...
					cout << "Nama mata kuliah :"<< recMhs[i].getNamamatkul()<<endl;
					cout << "Kode mata kuliah :"<< recMhs[i].getKodematkul()<<endl;
					cout << "Semester mata kuliah :"<< recMhs[i].getSemestermatkul()<<endl;
					cout << "Bobot mata kuliah :"<< recMhs[i].getBobotmatkul()<<endl;
